...
async function checkOrdersVerbose() {
    try {
        await mongoose.connect(mongoURI);
        const Order = mongoose.model('Order', new mongoose.Schema({ status: String, paid: Boolean, totalAmount: Number, brand: mongoose.Schema.Types.ObjectId }, { strict: false }));
